...
//https://github.com/OneDrive/samples/tree/a875148366eddcd733e2b64e237b4a1343cfe299/scenarios/throttling-ratelimit-handling/RateLimitDemo
	...
	internal sealed class ThrottlingHandler : DelegatingHandler {
		...
		protected override async Task<HttpResponseMessage> SendAsync(HttpRequestMessage request, CancellationToken cancellationToken) {
			...
			while (true) {
				...
				Console.WriteLine($"[red]Throttling {apiType} request, waiting for {waitTime.Seconds} seconds[/]");
